          ...
          <div class="grid grid-cols-1 gap-4">
              ...
              <div class="card p-4 bg-green-200 text-blue-700 shadow-md rounded-lg">
                  <div class="space-y-2">
                      ...
                      <h3 class="font-bold text-xl text-indigo-800">{{ currentReconciliation.bcp.beneficiary }}</h3>
                      <p class="font-bolld text-lg text-slate-800">Monto: {{ currentReconciliation.bcp.amount }}</p>
